...
public class AuthController(IAuthService authService, ILogger<AuthController> logger) : ControllerBase
{
    ...
    {
        // Should be edited so that i have the default frontend origin as a fallback
        var origin = Request.Headers.Origin.ToString();
        
        var result = await _authService.RegisterAsync(request, origin, cancellationToken);
    ...
    public async Task<IActionResult> ResendConfirmationEmail([FromBody] ResendConfirmationEmailRequest request, CancellationToken cancellationToken)
    {
        ...
        var result = await _authService.ResendConfirmationEmailAsync(request, origin);
    ...
    public async Task<IActionResult> ForgetPassword([FromBody] ForgetPasswordRequest request)
    {
        ...
        var result = await _authService.SendResetPasswordCodeAsync(request.Email, origin);
