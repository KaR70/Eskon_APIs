...
namespace Eskon.Infrastructure.Migrations
{
    ...
    [Migration("20251124220049_SeedLocationsAndHouses")]
    partial class SeedLocationsAndHouses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eskon.Api.Entities.Amenity", b =>
                {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Eskon.Api.Entities.House", b =>
                {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.HouseAmenity", b =>
                {
                    b.Property<int>("HouseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eskon.Api.Entities.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eskon.Api.Entities.MediaItem", b =>
                {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.SavedList", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Eskon.Api.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("Eskon.Api.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("Eskon.Api.Entities.House", b =>
                {
                    b.HasOne("Eskon.Api.Entities.Location", "Location")
                        .WithMany("Houses")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Eskon.Api.Entities.ApplicationUser", "Owner")
            ...
            modelBuilder.Entity("Eskon.Api.Entities.HouseAmenity", b =>
                {
                    b.HasOne("Eskon.Api.Entities.Amenity", "Amenity")
                        .WithMany("HouseAmenities")
                        .HasForeignKey("AmenityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Eskon.Api.Entities.House", "House")
                        .WithMany("HouseAmenities")
            ...
            modelBuilder.Entity("Eskon.Api.Entities.Review", b =>
                {
                    ...
                    b.HasOne("Eskon.Api.Entities.ApplicationUser", "User")
                        .WithMany("Reviews")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Eskon.Api.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Eskon.Api.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
